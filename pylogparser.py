...
def combine_png_to_pdf(node):
    base_dir = getcwd()
    graph_file_names = ["-clones.jpg", "-shallow_shallow_clones.jpg", "-refs.jpg", "-fetches.jpg", "-pushes.jpg",
                        "-unclassified.jpg", "-summary.jpg", "-max_connections.jpg", "-protocols.jpg", "-operations.jpg",
                        "-top_cloned.jpg", "-top_shallow.jpg", "-top_fetched.jpg", "-top_pushed.jpg"]
...
def main():
    ...
    for node in all_nodes:
        ...
        if options.json == True:
            ...
            Graph.graph_parsed(node, hourly_breakdown, system_stats, options.dark_mode, options.verbose, options.throttle_graph)
